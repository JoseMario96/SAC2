<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_MantenimientoOdontograma.aspx.cs" Inherits="SAC.formularios.frm_MantenimientoOdontograma" EnableEventValidation="false" %>
                ...
                <div class="row">
                    ...
                    <div class="input-field col s2">
                        <asp:UpdatePanel runat="server">
                            <ContentTemplate>
                                <asp:Button ID="Button1" runat="server" Text="Guardar" class="waves-effect waves-light btn" OnClick="Button1_Click" />
                            </ContentTemplate>
                        </asp:UpdatePanel>

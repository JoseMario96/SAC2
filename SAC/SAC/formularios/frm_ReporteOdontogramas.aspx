    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="row espacio">
                ...
                <div class="row">
                    ...
                    <asp:GridView ID="GridView_reporteOdontograma" aligne="center" HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="black" class="col s12"
                        runat="server" AutoGenerateColumns="False" Height="174px" AllowPaging="true" PageSize="30" OnSelectedIndexChanged="GridView_reporteOdontograma_SelectedIndexChanged" OnPageIndexChanging="GridView_reporteOdontograma_PageIndexChanging" OnRowDataBound="GridView_reporteOdontograma_RowDataBound">
                        <Columns>
            ...
            <asp:Panel ID="Panel1" runat="server">
                <div id="ReporteO" style="display: none" tabindex="-1">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_MantenimientoOdontograma2.aspx.cs" Inherits="SAC.formularios.frm_MantenimientoOdontograma2" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('input[type=radio][name=accion]').change(function () {
                if (this.value == 'odontogramaG') {
                    alert("1");

                }
                else if (this.value == 'odontogramaN') {
                    alert("2");
                }
            });
    </script>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            function getPosition(event) {
                var x = event.pageX;// pintar en eje x
                ...
                else if (seleccion == 'odontogramaG') {
                    accion = 'odontogramaG';
                }
                else if (seleccion == 'odontogramaN') {
                    accion = 'odontogramaN';
                }
            ...
            function Marcar(event) {
                var x = event.pageX; // Donde esta la posicion del mouse en el eje x
            ...
            function pintarclick(Vectorseccion, vectorcolor, vectorfecha) {
                ...
                ordenar(fech2, colorsec2, secciones2);

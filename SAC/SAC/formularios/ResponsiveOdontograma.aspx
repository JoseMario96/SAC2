...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <h1>Probandooooooooooooooooooooooo</h1>
            <h1>Probandooooooooooooooooooooooo</h1>
            ...
            <div id="canvasesdiv" style="position: relative; width: 890px; height: 200px">
                <canvas class="lienzo" id="myCanvas" width="890" height="200" style="z-index: 1; position: absolute; left: 25%;"></canvas>
                <canvas class="lienzo" id="myCanvas2" width="890" height="200" style="z-index: 2; position: absolute; left: 25%;"></canvas>
                <canvas class="lienzo" id="myCanvas3" width="890" height="200" style="z-index: 3; position: absolute; left: 25%;"></canvas>
                <canvas class="lienzo" id="myCanvas4" width="890" height="200" style="z-index: 4; position: absolute; left: 25%;"></canvas>
            </div>
            <br />
            <br />
            <br />
            <br />
            <div id="radio_seccion" class="margenes" style='display: none;'>
        ...
        <script>
            ...
            function getPosition(event) {
                ...
                var x = event.x - 255;// pintar en eje x
                var y = event.y; // pintar en eje y

                var canvas = document.getElementById("myCanvas");
                var div_can = document.getElementById("canvasesdiv");

                var wid = div_can.scrollWidth;
                var wie = div_can.scrollHeight;
            ...
            function buscarmarcas(diente) {
                for (var t = 0; t < BDMarca.length; t++) {
                    if (BDMarca[t] == diente) {
                        noborrarseccion = true;
                    }
                }
            }
            ...
            function Marcar(event) {
                var x = event.x - 255;//Donde esta la posicion del mouse en el eje x

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="inicio.aspx.cs" Inherits="SAC.inicio" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Clínica Dental Alina Camacho</title>
    ...
    <%--<link rel="stylesheet" id="theme_switch" href="css/style.css"/>--%>
...
<body>
        ...
        <div class="container">
            ...
            <nav class="navbar navbar-default">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">Clínica Dental Alina Camacho</a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="#" data-nav-section="services"><span>Odontograma</span></a></li>
                        <li><a href="#" data-nav-section="about"><span>Citas</span></a></li>
                        <li><a href="#" data-nav-section="contact"><span>Usuarios</span></a></li>
                    </ul>
                </div>
            </nav>
            <!-- </div> -->
                ...
                <div class="text-inner">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="to-animate">Clínica Dental Alina Camacho</h1>
        ...
        <div class="container">
            ...
            <div class="row row-bottom-padded-sm">
                <div class="col-md-4 col-sm-6 col-xxs-12">
                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/agregar.png" OnClick="ImageButton1_Click1" />
                    <%--<a href="images/agregar.png" class="fh5co-project-item image-popup to-animate">
                ...
                <div class="col-md-4 col-sm-6 col-xxs-12">
                    <a href="images/actualizar.png" class="fh5co-project-item image-popup to-animate">
                ...
                <div class="col-md-4 col-sm-6 col-xxs-12">
                    <a href="images/buscar.png" class="fh5co-project-item image-popup to-animate">
    ...
    <section id="fh5co-testimonials" data-section="testimonials">
        <div class="container">
            ...
            <div class="row row-bottom-padded-sm">
                ...
                <div class="col-md-4 col-sm-6 col-xxs-12">
                    <a href="images/reporte.png" class="fh5co-project-item image-popup to-animate">
    ...
    <section id="fh5co-services" data-section="services">
        <div class="container">
            <div class="row">
                <div class="col-md-12 section-heading text-center">
                    <h2 class="to-animate">Odontograma</h2>
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 subtext to-animate">
                            <h3>Agregar un odontograma</h3>
                        </div>
                    </div>
                </div>
            </div>
